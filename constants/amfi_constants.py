...
SECTOR_KEYWORDS: Dict[str, List[str]] = {
    ...
    "Commodities":           ["commodit", "metal", "mining", "resources"],
    ...
    "International":         ["international equity", "global agri",
                              "asian equity", "japan equity", "taiwan equity",
                              "us equity", "us bluechip", "us value equity",
                              "asean equity", "emerging market", "global emerging",
                              "europe", "brazil fund", "greater china",
                              "offshore fund", "off-shore fund", "overseas", "world"],
    ...
    "Special Opportunities": ["special opportunities", "special situation",
                              "opportunities fund", "india opportunities"],
}
...
FOF_KEYWORDS: Dict[str, List[str]] = {
    ...
    "International Equity": ["us equity", "us specific equity", "nasdaq", "global equity",
                             ...
                             "global stable equity", "global advantage",
                             "global emerging", "emerging market",
                             "developed market", "developed world",
                             "europe", "greater china", "hang seng",
                             "asia pacific", "asean", "japan",
                             "s&p 500", "nyse fang", "eqqq",
                             "overseas equity", "international reit",
                             "global select real estate",
                             "us treasury", "us specific debt", "us specific treasury",
                             "us opportunities", "us technology", "global excellence",
                             "u.s. opportunities"],
    "Domestic Equity":      ["diversified equity", "flexicap passive",
                             "all cap active", "all cap omni",
                             "nifty 50 etf", "nifty next 50",
                             "bse 200", "bse 500", "bse india",
                             "nifty 200", "nifty 500",
                             "multi sector passive", "multi factor passive",
                             "nifty 100", "nifty alpha", "nifty low volatility",
                             "nifty midsmall", "nifty smallcap",
                             "momentum quality", "alpha 30",
                             "equal weight etf"],
    "Debt":                 ["bharat bond", "g-sec fund of fund", "5 year g-sec",
                             "bond etf fof", "bond plus sdl",
                             "diversified debt", "aaa bond"],
    "Arbitrage / Income":   ["arbitrage", "income plus"],
    "Multi Asset":          ["multi asset", "multi-asset", "multi - asset",
                             "asset allocation", "life stage", "dynamic asset allocation",
                             "aggressive hybrid", "conservative hybrid", "balanced"],
    "Thematic ETF FOF":     ["defence", "power etf", "hospitals", "capital markets",
                             "nifty ev", "manufacturing etf", "metal etf",
                             "consumption etf", "digital etf", "pse etf",
                             "internet etf", "india defence", "india internet",
