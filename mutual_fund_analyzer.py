...
class MutualFundAnalyzer:
    ...
    def _display_metrics(self, rolling_data, calendar_data, static_sharpe_data, rolling_sharpe_data=None):
        """
    ...
    def process_scheme(self):
        ...
        self._display_metrics(rolling_data, calendar_data, static_sharpe_data, rolling_sharpe_data)
